...
------------ | ------------- | ------------- | -------------
**table_id** | **str** | The ID of the table; leave blank for new tables | [optional] 
**path** | **str** | The Path of the location of this table object; leave blank for new tables | [optional] 
