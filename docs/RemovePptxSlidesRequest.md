...
**start_delete_slide_number** | **int** | Slide number (1-based) to start deleting slides; inclusive | [optional] 
**end_delete_slide_number** | **int** | Slide number (1-based) to stop deleting slides; inclusive | [optional] 
