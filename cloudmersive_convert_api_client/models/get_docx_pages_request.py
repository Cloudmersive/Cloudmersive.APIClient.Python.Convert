...
class GetDocxPagesRequest(object):
    ...
    def input_file_bytes(self):
        """Gets the input_file_bytes of this GetDocxPagesRequest.  # noqa: E501

        Optional: Bytes of the input file to operate on  # noqa: E501

        :return: The input_file_bytes of this GetDocxPagesRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_bytes(self, input_file_bytes):
        """Sets the input_file_bytes of this GetDocxPagesRequest.

        Optional: Bytes of the input file to operate on  # noqa: E501

        :param input_file_bytes: The input_file_bytes of this GetDocxPagesRequest.  # noqa: E501
        :type: str
        """
    ...
    def input_file_url(self):
        """Gets the input_file_url of this GetDocxPagesRequest.  # noqa: E501
        ...
        :return: The input_file_url of this GetDocxPagesRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_url(self, input_file_url):
        """Sets the input_file_url of this GetDocxPagesRequest.

        Optional: URL of a file to operate on as input.  This can be a public URL, or you can also use the begin-editing API to upload a document and pass in the secure URL result from that operation as the URL here (this URL is not public).  # noqa: E501

        :param input_file_url: The input_file_url of this GetDocxPagesRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetDocxPagesRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetDocxPagesRequest):
            return False
