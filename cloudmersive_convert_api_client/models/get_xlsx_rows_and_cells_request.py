...
class GetXlsxRowsAndCellsRequest(object):
    ...
    def __init__(self, input_file_bytes=None, input_file_url=None, worksheet_to_query=None):  # noqa: E501
        """GetXlsxRowsAndCellsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def input_file_bytes(self):
        """Gets the input_file_bytes of this GetXlsxRowsAndCellsRequest.  # noqa: E501

        Optional: Bytes of the input file to operate on  # noqa: E501

        :return: The input_file_bytes of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_bytes(self, input_file_bytes):
        """Sets the input_file_bytes of this GetXlsxRowsAndCellsRequest.

        Optional: Bytes of the input file to operate on  # noqa: E501

        :param input_file_bytes: The input_file_bytes of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        :type: str
        """
    ...
    def input_file_url(self):
        """Gets the input_file_url of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        ...
        :return: The input_file_url of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_url(self, input_file_url):
        """Sets the input_file_url of this GetXlsxRowsAndCellsRequest.

        Optional: URL of a file to operate on as input.  This can be a public URL, or you can also use the begin-editing API to upload a document and pass in the secure URL result from that operation as the URL here (this URL is not public).  # noqa: E501

        :param input_file_url: The input_file_url of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        :type: str
        """
    ...
    def worksheet_to_query(self):
        """Gets the worksheet_to_query of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        ...
        :return: The worksheet_to_query of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        :rtype: XlsxWorksheet
        """
    ...
    def worksheet_to_query(self, worksheet_to_query):
        """Sets the worksheet_to_query of this GetXlsxRowsAndCellsRequest.

        Optional; Worksheet (tab) within the spreadsheet to get the rows and cells of; leave blank to default to the first worksheet  # noqa: E501

        :param worksheet_to_query: The worksheet_to_query of this GetXlsxRowsAndCellsRequest.  # noqa: E501
        :type: XlsxWorksheet
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetXlsxRowsAndCellsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetXlsxRowsAndCellsRequest):
            return False
