...
class GetXlsxCellRequest(object):
    ...
    def __init__(self, input_file_bytes=None, input_file_url=None, worksheet_to_query=None, row_index=None, cell_index=None):  # noqa: E501
        """GetXlsxCellRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def input_file_bytes(self):
        """Gets the input_file_bytes of this GetXlsxCellRequest.  # noqa: E501

        Optional: Bytes of the input file to operate on  # noqa: E501

        :return: The input_file_bytes of this GetXlsxCellRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_bytes(self, input_file_bytes):
        """Sets the input_file_bytes of this GetXlsxCellRequest.

        Optional: Bytes of the input file to operate on  # noqa: E501

        :param input_file_bytes: The input_file_bytes of this GetXlsxCellRequest.  # noqa: E501
        :type: str
        """
    ...
    def input_file_url(self):
        """Gets the input_file_url of this GetXlsxCellRequest.  # noqa: E501
        ...
        :return: The input_file_url of this GetXlsxCellRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_url(self, input_file_url):
        """Sets the input_file_url of this GetXlsxCellRequest.

        Optional: URL of a file to operate on as input.  This can be a public URL, or you can also use the begin-editing API to upload a document and pass in the secure URL result from that operation as the URL here (this URL is not public).  # noqa: E501

        :param input_file_url: The input_file_url of this GetXlsxCellRequest.  # noqa: E501
        :type: str
        """
    ...
    def worksheet_to_query(self):
        """Gets the worksheet_to_query of this GetXlsxCellRequest.  # noqa: E501
        ...
        :return: The worksheet_to_query of this GetXlsxCellRequest.  # noqa: E501
        :rtype: XlsxWorksheet
        """
    ...
    def worksheet_to_query(self, worksheet_to_query):
        """Sets the worksheet_to_query of this GetXlsxCellRequest.

        Optional; Worksheet (tab) within the spreadsheet to get the rows and cells of; leave blank to default to the first worksheet  # noqa: E501

        :param worksheet_to_query: The worksheet_to_query of this GetXlsxCellRequest.  # noqa: E501
        :type: XlsxWorksheet
        """
    ...
    @property
    def row_index(self):
        """Gets the row_index of this GetXlsxCellRequest.  # noqa: E501

        0-based index of the row, 0, 1, 2, ... to retrieve  # noqa: E501

        :return: The row_index of this GetXlsxCellRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def row_index(self, row_index):
        """Sets the row_index of this GetXlsxCellRequest.

        0-based index of the row, 0, 1, 2, ... to retrieve  # noqa: E501

        :param row_index: The row_index of this GetXlsxCellRequest.  # noqa: E501
        :type: int
        """
    ...
    @property
    def cell_index(self):
        """Gets the cell_index of this GetXlsxCellRequest.  # noqa: E501

        0-based index of the cell, 0, 1, 2, ... in the row to retrieve  # noqa: E501

        :return: The cell_index of this GetXlsxCellRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def cell_index(self, cell_index):
        """Sets the cell_index of this GetXlsxCellRequest.

        0-based index of the cell, 0, 1, 2, ... in the row to retrieve  # noqa: E501

        :param cell_index: The cell_index of this GetXlsxCellRequest.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetXlsxCellRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetXlsxCellRequest):
            return False
