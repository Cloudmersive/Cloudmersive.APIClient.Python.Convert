...
class GetDocxGetCommentsRequest(object):
    ...
    def __init__(self, input_file_bytes=None, input_file_url=None):  # noqa: E501
        """GetDocxGetCommentsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def input_file_bytes(self):
        """Gets the input_file_bytes of this GetDocxGetCommentsRequest.  # noqa: E501

        Optional: Bytes of the input file to operate on  # noqa: E501

        :return: The input_file_bytes of this GetDocxGetCommentsRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_bytes(self, input_file_bytes):
        """Sets the input_file_bytes of this GetDocxGetCommentsRequest.

        Optional: Bytes of the input file to operate on  # noqa: E501

        :param input_file_bytes: The input_file_bytes of this GetDocxGetCommentsRequest.  # noqa: E501
        :type: str
        """
    ...
    def input_file_url(self):
        """Gets the input_file_url of this GetDocxGetCommentsRequest.  # noqa: E501
        ...
        :return: The input_file_url of this GetDocxGetCommentsRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def input_file_url(self, input_file_url):
        """Sets the input_file_url of this GetDocxGetCommentsRequest.

        Optional: URL of a file to operate on as input.  This can be a public URL, or you can also use the begin-editing API to upload a document and pass in the secure URL result from that operation as the URL here (this URL is not public).  # noqa: E501

        :param input_file_url: The input_file_url of this GetDocxGetCommentsRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetDocxGetCommentsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetDocxGetCommentsRequest):
            return False
