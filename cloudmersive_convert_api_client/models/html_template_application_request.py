...
from cloudmersive_convert_api_client.models.html_template_operation import HtmlTemplateOperation  # noqa: F401,E501


class HtmlTemplateApplicationRequest(object):
    ...
    swagger_types = {
        ...
        'operations': 'list[HtmlTemplateOperation]'
    }
    ...
    def __init__(self, html_template=None, html_template_url=None, operations=None):  # noqa: E501
        """HtmlTemplateApplicationRequest - a model defined in Swagger"""  # noqa: E501

        self._html_template = None
        self._html_template_url = None
        self._operations = None
        self.discriminator = None

        if html_template is not None:
            self.html_template = html_template
        if html_template_url is not None:
    ...
    def html_template_url(self):
        ...
        :rtype: str
        """
        return self._html_template_url

    @html_template_url.setter
    def html_template_url(self, html_template_url):
        ...
        self._html_template_url = html_template_url
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HtmlTemplateApplicationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HtmlTemplateApplicationRequest):
            return False
