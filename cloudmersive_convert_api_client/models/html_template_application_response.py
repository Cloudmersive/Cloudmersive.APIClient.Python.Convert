...
class HtmlTemplateApplicationResponse(object):
    ...
    def __init__(self, successful=None, final_html=None):  # noqa: E501
        """HtmlTemplateApplicationResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HtmlTemplateApplicationResponse):
            return False
