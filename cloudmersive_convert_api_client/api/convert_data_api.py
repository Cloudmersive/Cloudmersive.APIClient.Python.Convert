...
class ConvertDataApi(object):
    ...
    def convert_data_xml_to_json(self, **kwargs):  # noqa: E501
        """XML to JSON conversion  # noqa: E501

        Convert an XML string or file into JSON  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.convert_data_xml_to_json(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.convert_data_xml_to_json_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.convert_data_xml_to_json_with_http_info(**kwargs)  # noqa: E501
            return data

    def convert_data_xml_to_json_with_http_info(self, **kwargs):  # noqa: E501
        """XML to JSON conversion  # noqa: E501

        Convert an XML string or file into JSON  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.convert_data_xml_to_json_with_http_info(async=True)
        >>> result = thread.get()
