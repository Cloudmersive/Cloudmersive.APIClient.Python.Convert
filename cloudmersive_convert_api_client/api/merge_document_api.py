...
class MergeDocumentApi(object):
    ...
    def merge_document_docx(self, input_file1, input_file2, **kwargs):  # noqa: E501
        ...
        Combine multiple Office Word Documents (docx) into one single Office Word documents  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.merge_document_docx(input_file1, input_file2, async=True)
        >>> result = thread.get()
    ...
    def merge_document_docx_with_http_info(self, input_file1, input_file2, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.merge_document_docx_with_http_info(input_file1, input_file2, async=True)
        >>> result = thread.get()
